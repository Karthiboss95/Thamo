...
//		String res = null;
//		File file = new File("C:\\Users\\HP\\eclipse-workspace\\Maven0\\excel\\Adactin.xlsx");
...
//	}
	...
	//to create sheet
	public void createSheet(String sheetName, int rowNum, int cellNum, String value ) throws IOException {
	...
	public void writeData(String sheetName, int rowNum, int cellNum, String value ) throws IOException {
		...
		Workbook workbook = new XSSFWorkbook(stream);
		Sheet sheet = workbook.getSheet(sheetName);
		Row getrow = sheet.getRow(rowNum);
		Cell getcell = getrow.createCell(cellNum);
		getcell.setCellValue(value);
		FileOutputStream out = new FileOutputStream(file);
		workbook.write(out);
